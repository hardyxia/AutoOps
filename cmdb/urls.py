...
from cmdb.views import instance, account, task
...
urlpatterns = [
    ...
    url(r'^instance/delete$', instance.InstanceDeleteView.as_view(), name='instance_delete'),
    ...
    url(r'^bind_user/delete$', instance.BindUserDeleteView.as_view(), name='bind_user_delete'),
    ...
    url(r'^service_url/delete$', instance.ServiceUrlDeleteView.as_view(), name='service_url_delete'),
    ...
    url(r'^task_file$', task.TaskFileTransfer.as_view(), name="task_file"),
    url(r'^task$', task.TaskView.as_view(), name="task"),
    url(r'^task_result$', task.TaskResultView.as_view(), name="task_result"),
